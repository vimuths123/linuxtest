                ...
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ route('products.store') }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code')" autofocus autocomplete="code" />
                        ...
                        <div>
                            ...
                            <x-text-input id="expiry_date" name="expiry_date" type="date" class="mt-1 block w-full" :value="old('expiry_date')" autofocus autocomplete="expiry_date" />
